...
public:
    ...
    void setupUi(QMainWindow *Principal)
    {
        ...
        act_abrir_solucao->setObjectName(QString::fromUtf8("act_abrir_solucao"));
        act_fechar = new QAction(Principal);
        act_fechar->setObjectName(QString::fromUtf8("act_fechar"));
        act_sobre = new QAction(Principal);
        act_sobre->setObjectName(QString::fromUtf8("act_sobre"));
        centralWidget = new QWidget(Principal);
        centralWidget->setObjectName(QString::fromUtf8("centralWidget"));
        gb_grafo = new QGroupBox(centralWidget);
        gb_grafo->setObjectName(QString::fromUtf8("gb_grafo"));
        ...
        cmb_grafo->setObjectName(QString::fromUtf8("cmb_grafo"));
        cmb_grafo->setGeometry(QRect(10, 50, 171, 25));
        lbl_grafo = new QLabel(gb_grafo);
        lbl_grafo->setObjectName(QString::fromUtf8("lbl_grafo"));
        lbl_grafo->setGeometry(QRect(10, 30, 171, 17));
        chk_previsualizar = new QCheckBox(gb_grafo);
        chk_previsualizar->setObjectName(QString::fromUtf8("chk_previsualizar"));
        ...
        tab_solucao->setObjectName(QString::fromUtf8("tab_solucao"));
        ...
        txt_saida_grafo->setObjectName(QString::fromUtf8("txt_saida_grafo"));
        txt_saida_grafo->setGeometry(QRect(10, 50, 111, 25));
        txt_saida_grafo->setReadOnly(true);
        txt_saida_qtdInd = new QLineEdit(tab_solucao);
        txt_saida_qtdInd->setObjectName(QString::fromUtf8("txt_saida_qtdInd"));
        ...
        txt_saida_muta->setObjectName(QString::fromUtf8("txt_saida_muta"));
        txt_saida_muta->setGeometry(QRect(10, 200, 111, 25));
        txt_saida_muta->setReadOnly(true);
        txt_saida_cruza = new QLineEdit(tab_solucao);
        txt_saida_cruza->setObjectName(QString::fromUtf8("txt_saida_cruza"));
        ...
        txt_saida_qtdGera->setObjectName(QString::fromUtf8("txt_saida_qtdGera"));
        ...
        txt_saida_fitness->setObjectName(QString::fromUtf8("txt_saida_fitness"));
        ...
        txt_saida_semRnd->setObjectName(QString::fromUtf8("txt_saida_semRnd"));
        txt_saida_semRnd->setGeometry(QRect(10, 300, 111, 25));
        txt_saida_semRnd->setReadOnly(true);
        saida_semRnd = new QLabel(tab_solucao);
        saida_semRnd->setObjectName(QString::fromUtf8("saida_semRnd"));
        ...
        txt_saida_qtdPtSt->setObjectName(QString::fromUtf8("txt_saida_qtdPtSt"));
        ...
        plt_grafico->setObjectName(QString::fromUtf8("plt_grafico"));
        plt_grafico->setGeometry(QRect(140, 10, 671, 601));
        txt_saida_tempo = new QLineEdit(tab_solucao);
        txt_saida_tempo->setObjectName(QString::fromUtf8("txt_saida_tempo"));
        ...
        txt_saida_reducao->setObjectName(QString::fromUtf8("txt_saida_reducao"));
        ...
        gb_ams->setObjectName(QString::fromUtf8("gb_ams"));
        ...
        spn_ams_individuos->setObjectName(QString::fromUtf8("spn_ams_individuos"));
        ...
        spn_ams_cruzamento->setObjectName(QString::fromUtf8("spn_ams_cruzamento"));
        spn_ams_cruzamento->setGeometry(QRect(10, 100, 81, 26));
        spn_ams_cruzamento->setMaximum(100.000000000000000);
        spn_ams_mutacao = new QDoubleSpinBox(gb_ams);
        spn_ams_mutacao->setObjectName(QString::fromUtf8("spn_ams_mutacao"));
        spn_ams_mutacao->setGeometry(QRect(10, 150, 81, 26));
        spn_ams_mutacao->setMaximum(100.000000000000000);
        spn_ams_geracoes = new QSpinBox(gb_ams);
        spn_ams_geracoes->setObjectName(QString::fromUtf8("spn_ams_geracoes"));
        ...
        lbl_semente->setObjectName(QString::fromUtf8("lbl_semente"));
        lbl_semente->setGeometry(QRect(10, 230, 171, 17));
        txt_random = new QLineEdit(gb_ams);
        txt_random->setObjectName(QString::fromUtf8("txt_random"));
